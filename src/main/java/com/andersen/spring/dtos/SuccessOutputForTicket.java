...
/**
 *Implementation of the model for data transfer object returned when ticket is saved and traveller have enough money.
 *
 ...
 *
 * <p>The field {@code change} denotes the change of money amount of the object.
 * The field {@code change} is of type {@code int}.
 *
 * <p>The field {@code currency} denotes the result of the object.
 * The field {@code currency} is of type {@code String}.
 *
 * <p>This class is a member of the
 * <a href="{@docRoot}/com/andersen/spring/dtos/package-info.html">SuccessOutputForTicket</a>.
 *
...
@Getter
@Setter
public class SuccessOutputForTicket {
